...
class GamePanel(private val gameMap: GameMap) : JPanel(), KeyListener, ActionListener {
    ...
    init {
        ...
        addMob(Mob(17, 20, Color.RED, AggressiveStrategy()))
        addMob(Mob(2, 2, Color.GREEN, PassiveStrategy()))
        addMob(Mob(27, 27, Color.RED, AggressiveStrategy()))
        addMob(Mob(30, 35, Color.RED, AggressiveStrategy()))
        addMob(Mob(32, 40, Color.RED, AggressiveStrategy()))
        addMob(Mob(32, 45, Color.RED, AggressiveStrategy()))
